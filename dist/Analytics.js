...
const Utils_1 = require("./Utilities/Analytics/Utils");
class Analytics extends Sales_1.Sales {
    ...
    rankProductsBy(category, order) {
        const filteredSales = (0, Utils_1.filterByCategoryA)(category, this._sales);
        const itemQuantity = (0, Utils_1.countPerItem)(filteredSales);
        return { items: Object.entries(itemQuantity).sort((0, Utils_1.sortCallBack)(order)) };
    }
    /* This function accepts two required parameters.
      The category specifies either gender, age or coupon
    ...
    rankLocationSatisfactionBy(category, order) {
        const filteredSales = (0, Utils_1.filterByCategoryA)(category, this._sales);
        const locAvgSatisfaction = (0, Utils_1.averageSatisfaction)(filteredSales);
        return {
            locations: Object.entries(locAvgSatisfaction).sort((0, Utils_1.sortCallBack)(order)),
        };
    }
    ...
    rankLocationBy(acct, order, item) {
        const locQuantity = (0, Utils_1.countPerLocation)(acct, order, this._sales, item);
        return {
            locations: Object.entries(locQuantity).sort((0, Utils_1.sortCallBack)(order)),
        };
    }
